...
/**
 * Journeyrate generated by hbm2java
 */
public class Journeyrate implements java.io.Serializable {
	...
	public Journeyrate(Integer id, Integer journeyfrom, Integer journeyto, Integer reducerate, Double pricerate) {
		this.id = id;
	...
	public Journeyrate(Integer id, Integer journeyfrom, Integer journeyto, Integer reducerate, Double pricerate,
			Double thisprice, Double sumprice, String con1, String con2, String con3, String con4,
			String con5) {
		this.id = id;
		this.journeyfrom = journeyfrom;
		this.journeyto = journeyto;
	...
	public Integer getReducerate() {
		return this.reducerate;
	}

	public void setReducerate(Integer reducerate) {
		this.reducerate = reducerate;
	}
