...
public class Carriage implements java.io.Serializable {
	...
	public Carriage(Integer id, Train train, Integer cnumber) {
		this.id = id;
		this.train = train;
		this.cnumber = cnumber;
	}

	public Carriage(Integer id, Train train, Integer cnumber, Integer seatnumber, Integer type, String con1, String con2,
