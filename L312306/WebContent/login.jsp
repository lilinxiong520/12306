...
<body>
	<div class="htmleaf-container">
		<header class="htmleaf-header">
			<h1>${uuser1==null?"12306购票系统登录界面":"注册成功请登录"}<span>请在以下输入您的账号密码</span></h1>
			<div class="htmleaf-links">
				<a class="htmleaf-icon icon-htmleaf-home-outline" href="index.jsp" title="" target="_blank"><span> </span></a>
		        ...
		        <div class="container">
		            <div class="row">
		                <div class="col-md-offset-3 col-md-6">
		                     <form action="${pageContext.request.contextPath}/uuser_login.action" method="post" class="form-horizontal">
